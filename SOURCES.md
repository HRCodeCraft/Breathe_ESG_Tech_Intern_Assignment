...
1. **IATA codes not in lookup table**: Our seeded table has 30 airports. A real deployment needs all ~9,000 IATA codes. The open-source `ourairports.com` dataset is the standard source for this.
